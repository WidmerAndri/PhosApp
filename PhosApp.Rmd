...
load_data = function(page) {
  if (page == "page1") {
    list(
      msa_list = readRDS(url("https://raw.githubusercontent.com/WidmerAndri/PhosApp/main/MSA_as_df/1_MSA_df_SC_AT_HS.rds"))[1:1220],
      score_table = read.csv(url("https://raw.githubusercontent.com/WidmerAndri/PhosApp/main/scoring_tables/scoring_table_SC_AT_HS_git.csv"), sep = ";"),
