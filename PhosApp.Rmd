...
load_data = function(page) {
  if (page == "page1") {
    list(
      ...
      fasta_base = "https://raw.githubusercontent.com/WidmerAndri/PhosApp/main/fastas/fastas_SC_AT_HS/MSA_group_ClustalO_"
    )
  } else if (page == "page2") {
    list(
      ...
      fasta_base = "https://raw.githubusercontent.com/WidmerAndri/PhosApp/main/fastas/fastas_SC_AT/MSA_group_ClustalO_"
    )
  } else if (page == "page3") {
    list(
      ...
      fasta_base = "https://raw.githubusercontent.com/WidmerAndri/PhosApp/main/fastas/fastas_SC_HS/MSA_group_ClustalO_"
    )
  }
}
